...
import { BookOpen, Clock, CheckCircle, AlertCircle, Download, Award, TrendingUp, Bell, User, Megaphone, ArrowLeft, Printer, GraduationCap } from 'lucide-react'
                  ...
                  <div className="border-t border-slate-200 bg-slate-50/50 p-6 sm:p-8 grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                    ...
                    <div className="space-y-4 flex flex-col justify-between">
                      ...
                      <div className="flex flex-col sm:flex-row gap-3 pt-2 w-full">
                        ...
                        <button
                          onClick={() => {
                            // Save as PDF uses the same styled print functionality to invoke the browser's PDF generation
                            const printWindow = window.open('', '_blank')
                            if (!printWindow) return
